...
$logged = 0;
$sess_user_type = 'ADM';
$is_sys_admin = $is_super_admin = $is_admin = $is_hr = $is_hrm = $is_menu_closed = false;
$sess_info_str = '';
...
{	
	if($_SESSION[PROJ_SESSION_ID]->log_stat == "A")
	{
		...
		{		
			...
			case $USER_LEVEL_HR: { $is_hr = true; break; }
			case $USER_LEVEL_HRM: { $is_hrm = true; break; }
		}
...
/* 	$sess_info = (isset($_SESSION[PROJ_SESSION_ID]->info))? NotifyThis($_SESSION[PROJ_SESSION_ID]->info, 'info'): '';
	...
	$sess_info = (isset($_SESSION[PROJ_SESSION_ID]->info))?$_SESSION[PROJ_SESSION_ID]->info:'';
	$sess_success_info = (isset($_SESSION[PROJ_SESSION_ID]->success_info))?$_SESSION[PROJ_SESSION_ID]->success_info:'';
	$sess_error_info = (isset($_SESSION[PROJ_SESSION_ID]->error_info))?$_SESSION[PROJ_SESSION_ID]->error_info:'';
	$sess_alert_info = (isset($_SESSION[PROJ_SESSION_ID]->alert_info))?$_SESSION[PROJ_SESSION_ID]->alert_info:'';	
