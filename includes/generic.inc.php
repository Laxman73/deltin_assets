...
function FormatDate($date_val, $flag="A")
{
	...
	if($date_val != "" && $date_val!='0000-00-00' && $date_val!="0000-00-00 00:00:00")
	{
		...
		elseif($flag=="E")	$date_format = "d M Y, l";
...
function getVerifiedStatus($flag="")
{
	$str = "";
	if($flag=='Y') $str = '<span class="text-success"><i class="fa fa-check"></i></span>';
	else if($flag=='N') $str = '<span class="text-danger"><i class="fa fa-times"></i></span>';

	return $str;
}

function getStaffStatus($flag="")
{
	$str = "";
	if($flag=='A') $str = '<span class="bg-success p-2 text-white">Active</span>';
	else if($flag=='I') $str = '<span class="bg-danger p-2 text-white">Inactive</span>';
	else if($flag=='D') $str = '<span class="bg-warning p-2 text-white">Draft</span>';
