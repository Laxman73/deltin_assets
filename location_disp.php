...
if(isset($_POST['srch_mode']) && $_POST['srch_mode']=='SUBMIT')
{
  ...
  $cmbstatus = $_POST['cmbstatus'];
	...
	$params = '&keyword='.$txtkeyword.'&status='.$cmbstatus;
...
$dataArr = GetDataFromCOND("location", $cond.' order by vName');
